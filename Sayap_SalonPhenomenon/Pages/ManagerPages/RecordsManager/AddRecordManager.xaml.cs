...
namespace Sayap_SalonPhenomenon.Pages.ManagerPages.RecordsManager
{
    /// <summary>
    /// Логика взаимодействия для AddRecordManager.xaml
    /// </summary>
    public partial class AddRecordManager : Page
    {
        private Registrations _currentRegistrations = new Registrations();
        public AddRecordManager(Registrations selectedRecord)
        {
            InitializeComponent();
